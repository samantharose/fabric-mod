...
public class RoseQuartzArmourMaterial implements ArmorMaterial {
    ...
    @Override
    public Ingredient getRepairIngredient() { return Ingredient.ofItems(RegisterItems.ROSE_QUARTZ_MATERIAL); }
